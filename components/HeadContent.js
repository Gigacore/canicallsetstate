  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <meta property="og:url" content="http://canicallsetstate.in"/>
        <meta property="og:type" content="website"/>
        <meta property="og:title" content="🤔 Can I call setState()"/>
        <meta property="og:description" content="Handy little site to find if you can call setState() in React.js' lifecycles."/>
